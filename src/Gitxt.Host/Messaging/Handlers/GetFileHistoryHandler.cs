...
internal sealed class GetFileHistoryHandler(IGraphQueryService service, string fallbackRepo) : IMessageHandler
{
    public object? Handle(MessageContext ctx)
    {
        ...
        return service.GetFileHistory(repoPath, filePath);
    }
}
