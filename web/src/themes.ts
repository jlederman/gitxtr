...
const mocha: Theme = {
    ...
    accent: "#f5c2e7",
    sha: "#89b4fa",
    refBg: "rgba(166,227,161,0.18)",
    refFg: "#a6e3a1",
    selectionBg: "rgba(137,180,250,0.13)",
    lanes: ["#89b4fa", "#a6e3a1", "#f9e2af", "#f38ba8", "#cba6f7", "#94e2d5", "#fab387", "#eba0ac"],
    addBg: "rgba(166,227,161,0.13)",
    addFg: "#a6e3a1",
    delBg: "rgba(243,139,168,0.13)",
    delFg: "#f38ba8",
    hunk: "#89dceb",
    fhdr: "#cba6f7",
};
...
const macchiato: Theme = {
    ...
    accent: "#f5bde6",
    sha: "#8aadf4",
    refBg: "rgba(166,218,149,0.18)",
    refFg: "#a6da95",
    selectionBg: "rgba(138,173,244,0.14)",
    lanes: ["#8aadf4", "#a6da95", "#eed49f", "#ed8796", "#c6a0f6", "#8bd5ca", "#f5a97f", "#ee99a0"],
    addBg: "rgba(166,218,149,0.13)",
    addFg: "#a6da95",
    delBg: "rgba(237,135,150,0.13)",
    delFg: "#ed8796",
    hunk: "#91d7e3",
    fhdr: "#c6a0f6",
};
...
const latte: Theme = {
    ...
    accent: "#ea76cb",
    sha: "#1e66f5",
    refBg: "rgba(64,160,43,0.16)",
    refFg: "#40a02b",
    selectionBg: "rgba(30,102,245,0.12)",
    lanes: ["#1e66f5", "#40a02b", "#df8e1d", "#d20f39", "#8839ef", "#179299", "#fe640b", "#e64553"],
    addBg: "rgba(64,160,43,0.14)",
    addFg: "#40a02b",
    delBg: "rgba(210,15,57,0.12)",
    delFg: "#d20f39",
    hunk: "#209fb5",
    fhdr: "#8839ef",
};
